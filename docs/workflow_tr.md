...
- Bu aşamada otomatik satış siparişi / fatura oluşturma yoktur; süreç ERPNext standart akışıyla **manuel** ilerletilir (örn. tekliften **Satış Siparişi oluştur**, ardından gerekirse faturala).
